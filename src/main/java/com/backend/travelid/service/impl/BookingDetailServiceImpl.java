...
public class BookingDetailServiceImpl implements BookingDetailService {
    ...
    public Map getByID(Long bookingDetail) {
        ...
        if(getBaseOptional.isEmpty()){
            return response.Error("booking detail not found");
        }
    ...
    public Map saveBookingDetail(BookingDetail bookingDetail) {
        try {
            ...
            if(bookingDetail.getPhoneNumber() == null){
                return response.Error(Config.PHONE_NUMBER_REQUIRED);
            }
    ...
    public Map updateBookingDetail(BookingDetail bookingDetail) {
        try {
            ...
            if (bookingDetail.getPhoneNumber() != null)chekDataDBbookingDetail.get().setPhoneNumber(bookingDetail.getPhoneNumber());
